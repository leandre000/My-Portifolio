  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black">
      <div className="w-full max-w-md p-8 rounded-xl shadow bg-white dark:bg-black border border-black/10 dark:border-white/10 flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold mb-6 text-center font-sans">Sign Up</h1>
        <AuthForm
          type="signup"
        ...
        >
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            Already have an account? <Link href="/login" className="underline hover:text-black dark:hover:text-white">Login</Link>
          </p>
        </AuthForm>
      </div>
    </div>
